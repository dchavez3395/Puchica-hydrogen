<!-- PUCHICA NOTE (added 2026-06-21)
This is the raw upstream persona from the agency-agents repo. It's a generic
version, useful as inspiration but not Puchica-specific.

For Puchica-tuned versions, see:
- 01-seo-specialist.md        (adapted)
- 05-frontend-developer.md    (adapted -- most useful for code work)
- 06-image-prompt-engineer.md (adapted)
- frontend-design.md          (Puchica design voice, primary for any visual change)

For full Puchica context, see INDEX.md in this folder.
End of Puchica note. Original content below.
-->
