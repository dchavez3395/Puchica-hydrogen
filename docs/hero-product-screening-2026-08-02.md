# Hero-product screening — 2026-08-02
...
upsell candidate. It is not the paid-acquisition lead because its low selling
...
| Four foldable linen/sheet boxes | Established visual matches showed both-market routes but did not expose pack count | Walmart four-pack variants were US$29.99–33.49 | Conditional margin remains too small for paid CAC and depends on unproven four-pack mapping | CONDITIONAL_ORGANIC_LEAD |
| 25-piece clear drawer organizer | Exact DSers card showed 25 pieces, US$11.89–13.25, free U.S. shipping, 29 orders and 5.0 rating | Current public U.S. results cluster near US$16–18 | Price is below a viable dropship paid-acquisition band | REJECT_PAID_PRICE_PRESSURE |
| Twelve clear shoe boxes | Credible U.S. visual match landed near US$41.23; cheaper rows mixed variants or slow oversized routes | Current public 12-pack references are roughly US$55–60 | Less than 10% conservative contribution before missing costs | REJECT_PAID_LANDED_COST |
...
DSers Supplier Optimizer was given a public reference image for a four-piece
magnetic spice-storage rack. DSers warns that this feature is being adjusted
and some data may be incorrect, so these are discovery leads only.

### United States

Representative common rows displayed:

- US$13.82–13.90 item + US$1.99 Selection Standard, 7 days, zero displayed sales.
- US$13.78–13.84 item + US$1.99 Selection Standard, 7 days, 6 displayed sales.
- US$13.22–14.33 item + US$1.99 Selection Standard, 7 days, 17 displayed sales.
- US$10.01–17.27 item + US$1.99 Selection Standard, 6 days, 90 displayed sales.

### Canada

The same visual search displayed the corresponding common routes:

- US$13.82–13.90 item + US$2.16 Selection Standard, 7 days.
- US$13.78–13.84 item + US$2.16 Selection Standard, 7 days, 6 displayed sales.
...
using a 2.8% + $0.30 planning fee and 15% return/problem reserve:

- a US$15.32 landed supplier cost leaves about US$17.25 contribution, or 43.1%,
  before app allocation, FX, support, chargebacks, and other missing costs;
- a US$19.43 landed supplier cost leaves about US$13.14 contribution, or 32.9%,
  before those missing costs and is too tight for paid acquisition.

Therefore the exact chosen option should ideally land at or below **US$16** in
the worse market. A hard provisional ceiling of **US$18 landed** applies until
all missing costs are filled. These are screening controls, not a live price or
spend approval.

Public comparison references captured during screening:

- Walmart U.S., four-piece magnetic spice-rack listing, observed at US$41.70:
  `https://www.walmart.com/ip/19677355105`
- eBay, four-piece magnetic spice-storage rack listing and comparable results:
  `https://www.ebay.com/itm/167017604359`
...
- [ ] Open the strongest established supplier listing without relying on a
      welcome, coupon, or first-order price.
- [ ] Prove that the selected option is a four-piece magnetic rack set and
      record color, dimensions, materials, load guidance, included hardware,
      stock, and supplier SKU.
- [ ] Confirm the product is genuinely magnetic rather than adhesive-only and
      capture any surface-compatibility limitation.
- [ ] Capture exact option cost and tracked route to approved non-personal
      destinations in Canada and the United States.
- [ ] Confirm normal retail comparables are materially equivalent four-piece
      products rather than sponsored or clearance anomalies.
- [ ] Complete the missing-cost worksheet and require at least 30% contribution
      in the worse market, with practical room above that floor for paid CAC.
...
paying still requires separate owner authority. See
`docs/bundle-product-screen-2026-08-02.md` for the later bundle screen.
