...
nine; the charcoal packing-cube SKU remains Canada-only because its exact DSers
route returned `No Shipping` to the United States.
...
| Large Blue Handled Clothes Storage Bag | `14:350852#Large Blue` | Organic-limited | Organic-limited | Draft |
...
- Encoded the ten Canadian and nine U.S. exact SKUs in
