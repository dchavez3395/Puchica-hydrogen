...
export const DICTIONARIES = {
  en: {
    ...
    aside_close: 'Close',
    locale_change_aria: 'Change market',
    ...
    about_hero_sub:
      'Puchica is an independent Canadian shop with a focused selection of practical travel organizers for packing, luggage, cables, and toiletries. We keep the catalog small so the product details, options, and shipping information stay clear.',
    ...
    about_how_2_body:
      'The launch selection supports the same packing system across a suitcase, weekender, gym bag, or carry-on without creating another crowded catalog.',
