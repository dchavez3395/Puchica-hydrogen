...
export const DICTIONARIES = {
  en: {
    ...
    ship_cta_sub: 'Browse 6,000+ products with free shipping across Canada on orders over $75.',
    ...
    about_how_1_body: 'Our team checks new products constantly, vetted suppliers, social media, trends. No algorithm picks what goes up.',
    about_how_2_title: 'We vet it',
    about_how_2_body: 'Is it worth the money. Does the supplier deliver. Would we recommend it to a friend. If any answer is no, it doesn\u2019t make the cut.',
    about_how_3_title: 'You get it',
    about_how_3_body: 'If it passes, it\u2019s in the shop. It ships within 24 hours, with a pre-paid return label in every box.',
    ...
    about_story_3_title: '6,000+ picks and growing',
    about_story_3_body: 'The catalog grew to over six thousand products, every one checked by a human, shipped fast, backed by a 30-day return promise.',
    ...
    hero_split_body: '6,000+ hand-picked products across home, beauty, tech, pet, and more, shipped free across Canada.',
    hero_split_cta_primary: 'Shop best sellers',
    hero_split_cta_secondary: 'Browse all',
    hero_split_trust: 'Free shipping across Canada · 30-day returns',
    ...
    trust_bar_shipping_sub: 'On orders over $75 across Canada',
    trust_bar_returns_h: '30-day returns',
    trust_bar_returns_sub: 'Pre-paid label in every box',
    trust_bar_curated_h: 'Curated in Toronto',
    trust_bar_curated_sub: 'Hand-picked by people who care',
    ...
    home_roots_heading: 'From Central America to your doorstep.',
    home_roots_body: "Puchica, that's what you say when something catches you off guard. A sunrise over Lake Atitlán. The first sip of coffee grown on volcanic slopes. A textile woven the same way for three generations in the highlands of Guatemala. From the markets of Antigua to the coast of Honduras, we bring that feeling here: goods with soul, curated with care, shipped across Canada.",
    ...
    home_shop_dept_heading: "Six departments. Six thousand finds.",
    ...
    // ── Hero stats ────────────────────────────────────────────────
    hero_store_stat_products: 'Products',
    hero_store_stat_departments: 'Departments',
    hero_store_stat_shipping: 'Free shipping',

    // ── Shop by category sub ──────────────────────────────────────
    shop_by_category_sub: 'Eight departments. Six thousand products. One store.',
  ...
  fr: {
    ...
    about_story_3_year: '2024',
    about_story_3_title: '6 000+ choix et ça grandit',
    about_story_3_body: 'Le catalogue a dépassé six mille produits, chacun vérifié par un humain, livré vite, garanti 30 jours.',
    ...
    hero_split_body: 'Plus de 6 000 produits triés sur le volet : maison, beauté, tech, animaux et plus, livraison gratuite partout au Canada.',
    hero_split_cta_primary: 'Voir les meilleures ventes',
    hero_split_cta_secondary: 'Tout parcourir',
    hero_split_trust: 'Livraison gratuite au Canada · Retours 30 jours',
    ...
    trust_bar_shipping_sub: 'Sur les commandes de plus de 75 $ au Canada',
    trust_bar_returns_h: 'Retours 30 jours',
    trust_bar_returns_sub: 'Étiquette préaffranchie dans chaque boîte',
    trust_bar_curated_h: 'Sélectionné à Toronto',
    trust_bar_curated_sub: 'Choisi par des gens qui s’en soucient',
    ...
    home_roots_heading: "D'Amérique centrale à votre porte.",
    home_roots_body: "Puchica, c'est ce qu'on dit quand quelque chose vous surprend. Un lever de soleil sur le lac Atitlán. La première gorgée de café cultivé sur les pentes volcaniques. Un textile tissé de la même manière depuis trois générations dans les hautes terres du Guatemala. Des marchés d'Antigua à la côte du Honduras, nous apportons ce sentiment ici : des produits avec âme, choisis avec soin, livrés partout au Canada.",
    ...
    home_shop_dept_heading: "Six départements. Six mille trouvailles.",
    ...
    hero_store_stat_products: 'Produits',
    hero_store_stat_departments: 'Départements',
    hero_store_stat_shipping: 'Livraison gratuite',
    shop_by_category_sub: 'Huit départements. Six mille produits. Une boutique.',
  ...
  es: {
    ...
    about_story_3_year: '2024',
    about_story_3_title: '6.000+ selecciones y creciendo',
    about_story_3_body: 'El catálogo creció a más de seis mil productos, cada uno revisado por una persona, enviado rápido, con garantía de devolución de 30 días.',
    ...
    hero_split_body: 'Más de 6,000 productos seleccionados a mano: hogar, belleza, tecnología, mascotas y más, envío gratis en todo Canadá.',
    hero_split_cta_primary: 'Ver los más vendidos',
    hero_split_cta_secondary: 'Ver todo',
    hero_split_trust: 'Envío gratis en Canadá · Devoluciones de 30 días',
    ...
    trust_bar_shipping_sub: 'En pedidos de más de $75 en Canadá',
    trust_bar_returns_h: 'Devoluciones 30 días',
    trust_bar_returns_sub: 'Etiqueta prepagada en cada caja',
    trust_bar_curated_h: 'Seleccionado en Toronto',
    trust_bar_curated_sub: 'Elegido por personas que se preocupan',
    ...
    home_roots_heading: "De Centroamérica a tu puerta.",
    home_roots_body: "Puchica, así se dice cuando algo te sorprende. Un amanecer sobre el lago Atitlán. El primer sorbo de café cultivado en laderas volcánicas. Un textil tejido de la misma forma por tres generaciones en los altiplanos de Guatemala. De los mercados de Antigua a la costa de Honduras, traemos ese sentimiento aquí: productos con alma, seleccionados con cariño, enviados a todo Canadá.",
    home_roots_signature: 'Hecho con alma · Made with soul',

    home_shop_dept_aria: "Comprar por departamento",
    home_shop_dept_eyebrow: "Explorar la tienda",
    home_shop_dept_heading: "Seis departamentos. Seis mil hallazgos.",
    ...
    hero_store_stat_products: 'Productos',
    hero_store_stat_departments: 'Departamentos',
    hero_store_stat_shipping: 'Envío gratis',
    shop_by_category_sub: 'Ocho departamentos. Seis mil productos. Una tienda.',
  ...
  'pt-br': {
    ...
    about_story_3_year: '2024',
    about_story_3_title: '6.000+ escolhas e crescendo',
    about_story_3_body: 'O catálogo cresceu para mais de seis mil produtos, cada um revisado por uma pessoa, enviado rápido, com garantia de devolução de 30 dias.',
    ...
    hero_split_body: 'Mais de 6.000 produtos selecionados a dedo: casa, beleza, tech, pets e mais, frete grátis em todo o Canadá.',
    hero_split_cta_primary: 'Ver mais vendidos',
    hero_split_cta_secondary: 'Ver tudo',
    hero_split_trust: 'Frete grátis no Canadá · Devoluções em 30 dias',
    ...
    trust_bar_shipping_sub: 'Em pedidos acima de $75 no Canadá',
    trust_bar_returns_h: 'Devoluções 30 dias',
    trust_bar_returns_sub: 'Etiqueta pré-paga em cada caixa',
    trust_bar_curated_h: 'Selecionado em Toronto',
    trust_bar_curated_sub: 'Escolhido por gente que se importa',
    ...
    home_roots_heading: "Da América Central à sua porta.",
    home_roots_body: "Puchica, é o que se diz quando algo te pega de surpresa. Um nascer do sol sobre o lago Atitlán. O primeiro gole de café cultivado em encostas vulcânicas. Um têxtil tecido da mesma forma há três gerações nas terras altas da Guatemala. Dos mercados de Antigua à costa de Honduras, trazemos esse sentimento para cá: produtos com alma, selecionados com carinho, enviados para todo o Canadá.",
    home_roots_signature: 'Hecho con alma · Feito com alma',

    home_shop_dept_aria: "Comprar por departamento",
    home_shop_dept_eyebrow: "Explorar a loja",
    home_shop_dept_heading: "Seis departamentos. Seis mil achados.",
    ...
    hero_store_stat_products: 'Produtos',
    hero_store_stat_departments: 'Departamentos',
    hero_store_stat_shipping: 'Frete grátis',
    shop_by_category_sub: 'Oito departamentos. Seis mil produtos. Uma loja.',
