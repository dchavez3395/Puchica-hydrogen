...
export const DICTIONARIES = {
  en: {
    ...
    ship_hero_sub: "From Toronto to the world. Free shipping across Canada on orders over $75, with reliable international delivery to 8 regions. Wherever you are, we'll get your order to you.",
    ...
    about_story_3_body: 'The catalog is being tightened around active, shoppable products that are easier to browse and backed by a 30-day return promise.',
    ...
    faq_returns_1_a: 'We offer 30-day returns on unused items in their original packaging. If something arrives damaged or wrong, we’ll make it right, no return needed for our mistake.',
    ...
    home_curate_step3_b: "Free shipping across Canada on orders over $75, 30-day returns, and real humans on support. Your order ships within 24 hours.",
  ...
  fr: {
    ...
    ship_hero_sub: "De Toronto vers le monde. Livraison gratuite partout au Canada pour les commandes de plus de 75 $, avec une livraison internationale fiable vers 8 régions. Où que vous soyez, nous livrons votre commande.",
    ...
    about_cta_sub: 'Des produits utiles, choisis par des humains. Prix clairs, retours sous 30 jours, livraison rapide.',
    ...
    about_story_3_body: 'Le catalogue est resserré autour de produits actifs, faciles à magasiner et couverts par une promesse de retour de 30 jours.',
    ...
    faq_returns_1_a: 'Nous offrons des retours sous 30 jours sur les articles inutilisés dans leur emballage d’origine. Si un article arrive endommagé ou erroné, nous corrigerons le tir, aucun retour nécessaire pour notre erreur.',
    ...
    trust_bar_returns_h: 'Retours 30 jours',
    ...
    home_curate_step3_b: "Livraison gratuite partout au Canada dès 75 $, retours sous 30 jours et de vraies personnes au support.",
  ...
  es: {
    ...
    ship_hero_sub: "De Toronto al mundo. Envío gratis en Canadá en pedidos superiores a $75, con entrega internacional confiable a 8 regiones. Estés donde estés, te haremos llegar tu pedido.",
    ...
    about_cta_sub: 'Productos útiles, elegidos por humanos. Precios claros, devoluciones de 30 días, entrega rápida.',
    ...
    about_story_3_body: 'El catálogo se está ajustando alrededor de productos activos, fáciles de comprar y respaldados por una promesa de devolución de 30 días.',
    ...
    faq_returns_1_a: 'Ofrecemos devoluciones de 30 días en artículos sin usar en su empaque original. Si algo llega dañado o incorrecto, lo solucionamos, no se necesita devolución por nuestro error.',
    ...
    trust_bar_returns_h: 'Devoluciones 30 días',
    ...
    home_curate_step3_b: "Envío gratis en todo Canadá desde $75, devoluciones en 30 días y personas reales en soporte.",
  ...
  'pt-br': {
    ...
    ship_hero_title_em: 'Entrega.',
    ship_hero_sub: "De Toronto para o mundo. Frete grátis no Canadá em pedidos acima de $75, com entrega internacional confiável para 8 regiões. Onde quer que você esteja, nós levamos o seu pedido até você.",
    ...
    about_cta_sub: 'Produtos úteis, escolhidos por humanos. Preços claros, devoluções em 30 dias, entrega rápida.',
    ...
    about_story_3_body: 'O catálogo está sendo ajustado em torno de produtos ativos, fáceis de comprar e apoiados por uma promessa de devolução em 30 dias.',
    ...
    faq_returns_1_a: 'Oferecemos devoluções em 30 dias para itens não usados na embalagem original. Se algo chegar danificado ou errado, resolveremos, sem necessidade de devolução para erro nosso.',
    ...
    trust_bar_returns_h: 'Devoluções 30 dias',
    ...
    home_curate_step3_b: "Frete grátis em todo o Canadá acima de $75, devoluções em 30 dias e pessoas reais no suporte.",
