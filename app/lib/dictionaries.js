...
export const DICTIONARIES = {
  en: {
    ...
    ship_title: 'From here to everywhere.',
    ship_sub: 'Toronto to Toronto, São Paulo to Berlin — Puchica ships across North & South America, the UK and the EU.',
    ship_section_aria: 'Shipping destinations',
    ship_compact_title: 'We ship to 20+ cities and growing.',
  ...
  fr: {
    ...
    ship_title: "D'ici à partout.",
    ship_sub: "De Toronto à Toronto, de São Paulo à Berlin — Puchica livre en Amérique du Nord et du Sud, au Royaume-Uni et dans l'UE.",
    ship_section_aria: 'Destinations de livraison',
    ship_compact_title: 'Nous livrons dans plus de 20 villes et ça grandit.',
  ...
  es: {
    ...
    ship_title: 'De aquí a todas partes.',
    ship_sub: 'De Toronto a Toronto, de São Paulo a Berlín — Puchica envía a Norteamérica, Sudamérica, el Reino Unido y la UE.',
    ship_section_aria: 'Destinos de envío',
    ship_compact_title: 'Enviamos a más de 20 ciudades y seguimos creciendo.',
    ship_cities_label: 'ciudades',
    ship_region_na: 'Norteamérica',
    ship_region_sa: 'Sudamérica',
  ...
  'pt-br': {
    ...
    ship_title: 'Daqui para qualquer lugar.',
    ship_sub: 'De Toronto a Toronto, de São Paulo a Berlim — a Puchica envia para a América do Norte e do Sul, Reino Unido e UE.',
    ship_section_aria: 'Destinos de envio',
    ship_compact_title: 'Enviamos para mais de 20 cidades e crescendo.',
