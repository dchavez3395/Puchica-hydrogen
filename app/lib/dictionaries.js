...
export const DICTIONARIES = {
  en: {
    ...
    reviews_aria: 'Customer reviews',
    reviews_eyebrow: 'Loved by 12,000+ shoppers',
    reviews_heading: 'What customers say',
    reviews_verified: 'Verified buyer',
    reviews_quote_1_text: 'I keep coming back. The quality is consistent, shipping is fast, and returns are painless.',
    reviews_quote_1_author: 'Maya R., Toronto',
    reviews_quote_2_text: 'Found a gift here I couldn’t find anywhere else. The packaging felt thoughtful.',
    reviews_quote_2_author: 'James P., Vancouver',
    reviews_quote_3_text: 'Customer service actually replies. I had a question about a product and got a real answer the same day.',
    reviews_quote_3_author: 'Sophie L., Montréal',

    newsletter_aria: 'Newsletter',
    newsletter_eyebrow: 'Join the list',
    newsletter_heading: 'Get 10% off your first order',
    newsletter_body: 'New drops, restocks, and the occasional sale — straight to your inbox, never spam.',
    newsletter_placeholder: 'you@example.com',
    newsletter_submit: 'Subscribe',
    newsletter_promise: 'No spam. Unsubscribe anytime.',
  },
  ...
  fr: {
    ...
    reviews_eyebrow: 'Aimé par plus de 12 000 acheteurs',
    reviews_heading: 'Ce que disent nos clients',
    reviews_verified: 'Acheteur vérifié',
    reviews_quote_1_text: 'Je reviens sans cesse. La qualité est constante, la livraison rapide, et les retours sont simples.',
    reviews_quote_1_author: 'Maya R., Toronto',
    reviews_quote_2_text: 'J’ai trouvé un cadeau introuvable ailleurs. L’emballage était soigné.',
    reviews_quote_2_author: 'James P., Vancouver',
    reviews_quote_3_text: 'Le service client répond vraiment. J’avais une question et j’ai eu une vraie réponse le jour même.',
    reviews_quote_3_author: 'Sophie L., Montréal',

    newsletter_aria: 'Infolettre',
    newsletter_eyebrow: 'Rejoignez la liste',
    newsletter_heading: 'Obtenez 10 % sur votre première commande',
    newsletter_body: 'Nouveautés, réassorts et ventes occasionnelles — dans votre boîte, jamais de spam.',
    newsletter_placeholder: 'vous@exemple.com',
    newsletter_submit: 'S’abonner',
    newsletter_promise: 'Pas de spam. Désabonnement en un clic.',
  },
  ...
  es: {
    ...
    reviews_eyebrow: 'Amado por más de 12,000 compradores',
    reviews_heading: 'Lo que dicen nuestros clientes',
    reviews_verified: 'Comprador verificado',
    reviews_quote_1_text: 'Sigo volviendo. La calidad es constante, el envío rápido y las devoluciones sin complicaciones.',
    reviews_quote_1_author: 'Maya R., Toronto',
    reviews_quote_2_text: 'Encontré un regalo que no hallé en ningún otro sitio. El empaque se sentía pensado.',
    reviews_quote_2_author: 'James P., Vancouver',
    reviews_quote_3_text: 'El servicio al cliente realmente responde. Hice una pregunta y obtuve respuesta el mismo día.',
    reviews_quote_3_author: 'Sophie L., Montréal',

    newsletter_aria: 'Boletín',
    newsletter_eyebrow: 'Únete a la lista',
    newsletter_heading: 'Obtén 10% en tu primer pedido',
    newsletter_body: 'Novedades, reposiciones y ofertas ocasionales — directo a tu correo, sin spam.',
    newsletter_placeholder: 'tu@ejemplo.com',
    newsletter_submit: 'Suscribirse',
    newsletter_promise: 'Sin spam. Cancela cuando quieras.',
  },
  ...
  'pt-br': {
    ...
    reviews_aria: 'Avaliações de clientes',
    reviews_eyebrow: 'Amado por mais de 12.000 compradores',
    reviews_heading: 'O que nossos clientes dizem',
    reviews_verified: 'Comprador verificado',
    reviews_quote_1_text: 'Volto sempre. A qualidade é constante, o envio é rápido e as devoluções são simples.',
    reviews_quote_1_author: 'Maya R., Toronto',
    reviews_quote_2_text: 'Encontrei um presente que não achei em nenhum outro lugar. A embalagem parecia pensada nos mínimos detalhes.',
    reviews_quote_2_author: 'James P., Vancouver',
    reviews_quote_3_text: 'O atendimento responde mesmo. Tive uma dúvida e recebi uma resposta de verdade no mesmo dia.',
    reviews_quote_3_author: 'Sophie L., Montréal',

    newsletter_aria: 'Newsletter',
    newsletter_eyebrow: 'Junte-se à lista',
    newsletter_heading: 'Ganhe 10% no seu primeiro pedido',
    newsletter_body: 'Novidades, reposições e promoções ocasionais — direto no seu e-mail, sem spam.',
    newsletter_placeholder: 'voce@exemplo.com',
    newsletter_submit: 'Inscrever',
    newsletter_promise: 'Sem spam. Cancele quando quiser.',
  },
};
