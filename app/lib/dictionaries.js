...
export const DICTIONARIES = {
  en: {
    ...
    mobile_announce_foot: 'Shipping shown at checkout · See return policy',
    ...
    // ── Hero ──────────────────────────────────────────────────────
    hero_eyebrow: 'Practical picks · U.S. delivery',
    ...
    ticker_returns: 'Return policy available',
    ...
    ship_title: 'U.S. delivery only.',
    ship_sub: 'Delivery is available to U.S. addresses only. Cost and estimated timing vary by product; confirm both at checkout. The estimate is not a guaranteed delivery date.',
    ...
    ship_hero_jump: 'See how delivery is confirmed',
    ship_launch_hero_sub: 'Delivery is available to U.S. addresses only. Cost and estimated timing are confirmed at checkout for the items in your cart.',
    ship_launch_regions_eye: 'Launch market',
    ship_launch_regions_title: 'Delivery is currently limited to the United States.',
    ship_launch_regions_sub: 'Checkout confirms product-level availability, cost, and estimated timing before payment.',
    ...
    ship_market_us_name: 'United States',
    ship_market_us_detail: 'Delivery availability, cost, and estimated timing are confirmed at checkout.',
    ...
    ship_regions_sub: 'Delivery is currently available only to U.S. addresses. Checkout confirms availability for each order.',
    ...
    ship_rates_us_eta: 'Confirmed before payment',
    ship_rates_us_badge: '',
    ship_rates_intl_flag: 'INTL',
    ship_rates_intl_title: 'International',
    ship_rates_intl_body: 'International delivery is not available during the U.S.-only launch.',
    ...
    ship_how_2_title: 'The supplier processes the order',
    ship_how_2_body: 'After checkout, order details are sent for supplier fulfillment. Processing time varies by product and supplier.',
    ...
    ship_track_body_1: 'Tracking details are emailed when the supplier and carrier make them available.',
    ...
    ship_cta_sub: 'Browse the active U.S. catalog with shipping options shown at checkout.',
    ...
    trust_returns_title: 'Return policy',
    ...
    product_trust_returns: 'Return policy',
    product_trust_returns_sub: 'review eligibility',
    ...
    product_shipping_body: 'Delivery is available to U.S. addresses only. Cost and estimated timing vary by product and are shown at checkout. Items may arrive separately from third-party suppliers; delivery estimates are not guaranteed.',
    product_returns_h: 'Returns',
    product_returns_body: "Return eligibility, the return window, and instructions are set out in our refund policy. Contact us before sending anything back so we can provide the correct next steps.",
    product_help_h: 'Need help?',
    product_help_body: 'Reach us through the contact page if you want help checking a product, order, or policy detail before you buy.',
    ...
    cart_empty_perk_returns: 'Return policy available',
    ...
    cart_summary_checkout_unavailable_btn: 'Checkout temporarily unavailable',
    cart_summary_checkout_unavailable_help: 'We could not prepare checkout. Refresh the cart and try again.',
    cart_summary_checkout_retry: 'Refresh cart',
    ...
    cart_summary_promo_invalid: 'That promo code could not be applied.',
    cart_recovery_one: 'Welcome back! You have {count} item in your cart.',
    ...
    cart_trust_returns: 'See return policy',
    cart_trust_shipping: 'Shipping shown at checkout',
    ...
    about_stat_returns_num: 'See policy',
    ...
    about_how_3_body: 'Before ordering, you can review the images, options, price, shipping details, and policy links in one place.',
    ...
    about_promise_quote: 'Before a product goes live, we review its listing, sellable variant, supplier mapping, and U.S. delivery route. We keep the catalog focused and remove products that do not meet those launch checks.',
    ...
    about_story_3_body: 'The catalog is being tightened around active, shoppable products with clearer product, delivery, and policy details.',
    ...
    about_values_4_body: 'Orders are fulfilled by mapped third-party suppliers. Shipping and return details are confirmed at checkout and in our policies.',
    ...
    contact_hero_sub: 'Questions about an order, a product, or a policy? Pick the channel that works for you and we will get back to you as soon as we can.',
    ...
    contact_promise_2_strong: 'Replies as soon as possible',
    contact_promise_2_body: 'Response times can vary, but we try to keep support practical and clear.',
    contact_promise_3_strong: 'Order help every day',
    contact_promise_3_body: 'We can help with tracking, returns, address changes, and product questions when support is available.',
    ...
    contact_faq_1_a: "Your tracking link is in the shipping confirmation email when tracking is available. If you have a question about delivery, email us with your order number.",
    contact_faq_2_q: 'Can I change or cancel my order?',
    contact_faq_2_a: 'Contact us as soon as possible with your order number. We will confirm whether a change or cancellation is still possible before fulfillment.',
    contact_faq_3_q: 'How do returns work?',
    contact_faq_3_a: 'Return eligibility and instructions are listed in our refund policy. Contact us before sending anything back so we can provide the correct next steps.',
    contact_faq_4_q: 'Where do you ship?',
    contact_faq_4_a: 'Delivery is currently available to U.S. addresses only. Cost and estimated timing are confirmed at checkout and are not guaranteed delivery dates.',
    contact_faq_5_q: 'Are the products in the photos exactly what I get?',
    contact_faq_5_a: 'Product photos and descriptions are there to help you compare before ordering. Review all images, options, and details carefully, and contact us if anything is unclear.',
    ...
    faq_orders_1_a: 'Delivery estimates vary by product and are shown at checkout for U.S. addresses. They are estimates, not guaranteed delivery dates.',
    faq_orders_2_q: 'Do you ship internationally?',
    faq_orders_2_a: 'No. Delivery is currently available only to U.S. addresses.',
    faq_orders_3_q: 'How do I track my order?',
    faq_orders_3_a: 'Tracking details are emailed when they become available. Contact us with your order number if you need help.',
    faq_orders_4_q: 'What are your shipping rates?',
    faq_orders_4_a: 'Shipping cost is shown at checkout for the selected products and U.S. delivery address before payment.',
    faq_returns_1_q: 'What is your return policy?',
    faq_returns_1_a: 'Our refund policy provides a 30-day return window, subject to its eligibility requirements. Contact us before sending anything back.',
    faq_returns_2_q: 'How do I start a return?',
    faq_returns_2_a: 'Contact us before returning an item. We will confirm eligibility, the return address, and the correct instructions; return shipping is arranged case by case.',
    faq_returns_3_q: 'When will I get my refund?',
    faq_returns_3_a: 'Approved refunds are issued to the original payment method, generally within 5–7 business days after the return is received and inspected.',
    faq_products_1_q: 'How do you review products?',
    faq_products_1_a: 'We review each listing, sellable variant, supplier mapping, and U.S. delivery route before launch. We do not independently authenticate every brand claim or laboratory-test every item; contact us before ordering if a detail matters to your purchase.',
    faq_products_2_q: 'Where do your products come from?',
    faq_products_2_a: 'Orders are fulfilled by mapped third-party suppliers, and product origin can vary. Review the listing images, selected option, delivery estimate, and policies before ordering.',
    faq_products_3_q: 'Is every product sourced from Central America?',
    faq_products_3_a: 'No. Puchica has Central American roots, but the current launch catalog is selected from third-party suppliers based on product details, mapping quality, and verified U.S. delivery routes.',
    ...
    faq_cta_sub: 'We read every message and reply as soon as we can.',
    ...
    hero_split_trust: 'Shipping shown at checkout · Return policy available',
    hero_trust_returns: 'See return policy',
    ...
    trust_bar_returns_h: 'Return policy',
    trust_bar_returns_sub: 'Review eligibility',
    ...
    world_map_eyebrow: 'U.S. delivery',
    world_map_heading: 'From our roots to your door.',
    world_map_sub: 'Delivery is currently limited to U.S. addresses. Product-level availability is confirmed before payment.',
  ...
  fr: {
    ...
    hero_eyebrow: 'Sélection pratique · Livraison aux États-Unis',
    ...
    ticker_returns: 'Politique de retour disponible',
    ...
    ship_title: 'Livraison aux États-Unis seulement.',
    ship_sub: 'La livraison est offerte uniquement aux adresses aux États-Unis. Le coût et le délai estimé varient selon le produit; confirmez-les à la caisse. Le délai estimé n’est pas garanti.',
    ...
    ship_hero_jump: 'Voir comment la livraison est confirmée',
    ship_launch_hero_sub: 'La livraison est offerte uniquement aux adresses aux États-Unis. Le coût et le délai estimé sont confirmés à la caisse pour les articles de votre panier.',
    ship_launch_regions_eye: 'Marché de lancement',
    ship_launch_regions_title: 'La livraison est actuellement limitée aux États-Unis.',
    ship_launch_regions_sub: 'La caisse confirme la disponibilité, le coût et le délai estimé de chaque produit avant le paiement.',
    ship_launch_rates_eye: 'Avant le paiement',
    ship_launch_rates_title: 'Des options claires pour votre commande.',
    ship_launch_rates_sub: 'La caisse affiche la disponibilité de livraison pour les articles et l’adresse choisis avant le paiement.',
    ship_market_us_name: 'États-Unis',
    ship_market_us_detail: 'La disponibilité, le coût et le délai estimé sont confirmés à la caisse.',
    ship_check_destination_title: 'Vérifiez votre adresse',
    ship_check_destination_body: 'Entrez votre adresse de livraison à la caisse pour voir les options disponibles.',
    ...
    ship_check_items_body: 'Les options varient selon le produit, la variante et l’adresse. Le résultat à la caisse s’applique à votre commande.',
    ship_check_items_eta: 'Aucune promesse avant la confirmation à la caisse',
    ship_check_tracking_title: 'Suivez votre commande',
    ship_check_tracking_body: 'Lorsqu’un service suivi est disponible, les détails sont envoyés après l’expédition.',
    ship_check_tracking_eta: 'Consultez la politique de livraison pour obtenir de l’aide',
    ...
    ship_cta_sub: 'Parcourez le catalogue actif pour les États-Unis; les options de livraison sont indiquées à la caisse.',
    ...
    trust_returns_title: 'Politique de retour',
    ...
    product_trust_returns: 'Politique de retour',
    product_trust_secure: 'Paiement sécurisé',
    product_trust_returns_sub: 'see the return policy',
    ...
    product_shipping_body: 'La livraison est offerte uniquement aux adresses aux États-Unis. Le coût et le délai estimé sont indiqués à la caisse. Les articles peuvent arriver séparément de fournisseurs tiers; les délais ne sont pas garantis.',
    product_returns_h: 'Retours',
    product_returns_body: 'Les conditions, le délai et les instructions de retour figurent dans notre politique de remboursement. Contactez-nous avant tout envoi afin de recevoir les bonnes instructions.',
    product_help_h: 'Besoin d’aide ?',
    product_help_body: 'Contactez-nous via la page de contact pour vérifier un produit, une commande ou une politique avant l’achat.',
    ...
    cart_empty_perk_returns: 'Politique de retour disponible',
    ...
    cart_summary_checkout_unavailable_btn: 'Paiement temporairement indisponible',
    cart_summary_checkout_unavailable_help: 'Nous n’avons pas pu préparer le paiement. Actualisez le panier et réessayez.',
    cart_summary_checkout_retry: 'Actualiser le panier',
    ...
    cart_summary_promo_invalid: 'Ce code promo n’a pas pu être appliqué.',
    cart_recovery_one: 'Bon retour! Vous avez {count} article dans votre panier.',
    cart_recovery_many: 'Bon retour! Vous avez {count} articles dans votre panier.',
    cart_recovery_cta: 'Terminer votre commande',
    ...
    mobile_announce_foot: 'Livraison à la caisse · Voir la politique de retour',
    mobile_announce_foot_sep: ' · ',
    ...
    cart_trust_returns: 'Voir la politique de retour',
    cart_trust_shipping: 'Livraison indiquée à la caisse',
    ...
    about_stat_returns_num: 'Voir la politique',
    ...
    about_how_3_body: 'Avant de commander, consultez les images, les options, le prix, les détails de livraison et les liens vers nos politiques au même endroit.',
    ...
    about_promise_quote: 'Avant la mise en ligne, nous vérifions la fiche, la variante vendable, le mappage fournisseur et la livraison aux États-Unis. Nous gardons un catalogue ciblé et retirons les produits qui ne satisfont pas ces contrôles.',
    ...
    about_story_3_body: 'Le catalogue se resserre autour de produits actifs avec des détails plus clairs sur les produits, la livraison et les politiques.',
    ...
    about_values_4_body: 'Les commandes sont traitées par des fournisseurs tiers associés. Les détails de livraison et de retour sont confirmés à la caisse et dans nos politiques.',
    ...
    contact_hero_sub: 'Une question sur une commande, un produit ou une politique? Choisissez le moyen de contact qui vous convient et nous vous répondrons dès que possible.',
    ...
    contact_promise_2_strong: 'Réponse dès que possible',
    contact_promise_2_body: 'Les délais de réponse peuvent varier; nous cherchons à fournir une aide pratique et claire.',
    contact_promise_3_strong: 'Aide aux commandes tous les jours',
    contact_promise_3_body: 'Nous pouvons aider avec le suivi, les retours, les changements d’adresse et les questions sur les produits lorsque le soutien est disponible.',
    ...
    contact_faq_1_a: "Votre lien de suivi figure dans le courriel de confirmation d'expédition lorsque le suivi est disponible. Pour toute question sur la livraison, écrivez-nous en indiquant votre numéro de commande.",
    contact_faq_2_q: 'Puis-je modifier ou annuler ma commande ?',
    contact_faq_2_a: 'Contactez-nous dès que possible avec votre numéro de commande. Nous confirmerons si une modification ou une annulation est encore possible avant le traitement.',
    contact_faq_3_q: 'Comment fonctionnent les retours ?',
    contact_faq_3_a: 'Les conditions et les instructions de retour figurent dans notre politique de remboursement. Contactez-nous avant tout envoi afin de recevoir les bonnes instructions.',
    contact_faq_4_q: 'Où livrez-vous ?',
    contact_faq_4_a: 'La livraison est actuellement offerte uniquement aux adresses aux États-Unis. Le coût et le délai estimé sont confirmés à la caisse et ne sont pas garantis.',
    contact_faq_5_q: 'Les produits sur les photos sont-ils exactement ce que je reçois ?',
    contact_faq_5_a: 'Les photos et descriptions servent à comparer les produits avant de commander. Vérifiez toutes les images, options et informations, puis contactez-nous si un détail reste incertain.',
    ...
    faq_orders_1_a: 'Les délais varient selon le produit et sont indiqués à la caisse pour les adresses aux États-Unis. Ce sont des estimations, pas des dates garanties.',
    faq_orders_2_q: 'Livrez-vous à l’international ?',
    faq_orders_2_a: 'Non. La livraison est actuellement offerte uniquement aux adresses aux États-Unis.',
    faq_orders_3_q: 'Comment puis-je suivre ma commande ?',
    faq_orders_3_a: 'Les détails de suivi sont envoyés par courriel lorsqu’ils deviennent disponibles. Contactez-nous avec votre numéro de commande si vous avez besoin d’aide.',
    faq_orders_4_q: 'Quels sont vos frais de livraison ?',
    faq_orders_4_a: 'Le coût de livraison est indiqué à la caisse selon les produits et l’adresse aux États-Unis avant le paiement.',
    faq_returns_1_q: 'Quelle est votre politique de retour ?',
    faq_returns_1_a: 'Notre politique de remboursement prévoit un délai de 30 jours, sous réserve des conditions d’admissibilité. Contactez-nous avant tout envoi.',
    faq_returns_2_q: 'Comment démarrer un retour ?',
    faq_returns_2_a: 'Contactez-nous avant tout retour. Nous confirmerons l’admissibilité, l’adresse et les instructions; les frais de retour sont traités au cas par cas.',
    faq_returns_3_q: 'Quand recevrai-je mon remboursement ?',
    faq_returns_3_a: 'Les remboursements approuvés sont versés au mode de paiement d’origine, généralement sous 5 à 7 jours ouvrables après réception et inspection.',
    faq_products_1_q: 'Comment vérifiez-vous les produits ?',
    faq_products_1_a: 'Avant le lancement, nous vérifions la fiche, la variante vendable, le mappage fournisseur et la livraison aux États-Unis. Nous n’authentifions pas indépendamment chaque affirmation de marque et ne testons pas chaque article en laboratoire; contactez-nous si un détail est essentiel.',
    faq_products_2_q: 'D’où viennent vos produits ?',
    faq_products_2_a: 'Les commandes sont traitées par des fournisseurs tiers associés et l’origine peut varier. Vérifiez les images, l’option choisie, le délai de livraison et les politiques avant de commander.',
    faq_products_3_q: 'Chaque produit vient-il d’Amérique centrale ?',
    faq_products_3_a: 'Non. Puchica a des racines centroaméricaines, mais le catalogue actuel provient de fournisseurs tiers choisis selon les détails produit, la qualité du mappage et les routes de livraison vérifiées aux États-Unis.',
    ...
    faq_cta_sub: 'Nous lisons chaque message et répondons dès que possible.',
    ...
    hero_trust_returns: 'Voir la politique de retour',
    ...
    trust_bar_returns_h: 'Politique de retour',
    trust_bar_returns_sub: 'Vérifier les conditions',
  ...
  es: {
    ...
    hero_eyebrow: 'Selección práctica · Entrega en EE. UU.',
    ...
    ticker_returns: 'Política de devoluciones disponible',
    ...
    ship_title: 'Entrega solo en EE. UU.',
    ship_sub: 'La entrega está disponible solo para direcciones en EE. UU. El costo y el plazo estimado varían según el producto; confírmalos al pagar. La fecha estimada no está garantizada.',
    ...
    ship_hero_jump: 'Ver cómo se confirma la entrega',
    ship_launch_hero_sub: 'La entrega está disponible solo para direcciones en EE. UU. El costo y el plazo estimado se confirman al pagar para los artículos de tu carrito.',
    ship_launch_regions_eye: 'Mercado de lanzamiento',
    ship_launch_regions_title: 'La entrega está limitada actualmente a Estados Unidos.',
    ship_launch_regions_sub: 'El checkout confirma la disponibilidad, el costo y el plazo estimado de cada producto antes del pago.',
    ship_launch_rates_eye: 'Antes de pagar',
    ship_launch_rates_title: 'Opciones claras para tu pedido.',
    ship_launch_rates_sub: 'El checkout muestra la disponibilidad para los artículos y la dirección seleccionados antes del pago.',
    ship_market_us_name: 'Estados Unidos',
    ship_market_us_detail: 'La disponibilidad, el costo y el plazo estimado se confirman al pagar.',
    ship_check_destination_title: 'Comprueba tu dirección',
    ship_check_destination_body: 'Introduce tu dirección al pagar para ver las opciones disponibles.',
    ship_check_destination_eta: 'Disponibilidad mostrada antes del pago',
    ship_check_items_title: 'Comprueba los artículos del carrito',
    ship_check_items_body: 'Las opciones varían según el producto, la variante y la dirección. El resultado del checkout se aplica a tu pedido.',
    ship_check_items_eta: 'Sin promesa de entrega hasta la confirmación',
    ship_check_tracking_title: 'Sigue tu pedido',
    ship_check_tracking_body: 'Cuando hay seguimiento disponible, los detalles se envían después del despacho.',
    ship_check_tracking_eta: 'Consulta la política de envío para obtener ayuda',
    ...
    ship_cta_sub: 'Explora el catálogo activo para EE. UU.; las opciones de envío aparecen al pagar.',
    ...
    trust_returns_title: 'Política de devoluciones',
    ...
    product_trust_returns: 'Política de devoluciones',
    product_trust_returns_sub: 'see the return policy',
    ...
    product_shipping_body: 'La entrega está disponible solo para direcciones en EE. UU. El costo y el plazo estimado aparecen al pagar. Los artículos pueden llegar por separado de proveedores externos; las fechas no están garantizadas.',
    product_returns_h: 'Devoluciones',
    product_returns_body: 'La elegibilidad, el plazo y las instrucciones de devolución figuran en nuestra política de reembolso. Contáctanos antes de enviar cualquier artículo para recibir los pasos correctos.',
    product_help_h: '¿Necesitas ayuda?',
    product_help_body: 'Contáctanos desde la página de contacto para verificar un producto, pedido o política antes de comprar.',
    ...
    cart_empty_perk_returns: 'Política de devoluciones disponible',
    ...
    cart_summary_checkout_unavailable_btn: 'El pago no está disponible temporalmente',
    cart_summary_checkout_unavailable_help: 'No pudimos preparar el pago. Actualiza el carrito e inténtalo de nuevo.',
    cart_summary_checkout_retry: 'Actualizar carrito',
    ...
    cart_summary_promo_invalid: 'No se pudo aplicar ese código promocional.',
    cart_recovery_one: 'Bienvenido de nuevo. Tienes {count} artículo en tu carrito.',
    cart_recovery_many: 'Bienvenido de nuevo. Tienes {count} artículos en tu carrito.',
    ...
    mobile_announce_foot: 'Envío al pagar · Ver política de devoluciones',
    mobile_announce_foot_sep: ' · ',
    ...
    cart_trust_returns: 'Ver política de devoluciones',
    cart_trust_shipping: 'Envío indicado al pagar',
    ...
    about_stat_returns_num: 'Ver política',
    ...
    about_how_3_body: 'Antes de comprar, revisa las imágenes, opciones, precio, detalles de entrega y enlaces a las políticas en un solo lugar.',
    ...
    about_promise_quote: 'Antes de publicar un producto, revisamos la ficha, la variante vendible, el mapeo del proveedor y la ruta de entrega a Estados Unidos. Mantenemos un catálogo enfocado y retiramos lo que no cumple esos controles.',
    ...
    about_story_3_body: 'El catálogo se centra en productos activos con detalles más claros sobre productos, entrega y políticas.',
    ...
    about_values_4_body: 'Los pedidos son procesados por proveedores externos vinculados. Los detalles de envío y devolución se confirman al pagar y en nuestras políticas.',
    ...
    contact_hero_sub: '¿Tienes preguntas sobre un pedido, producto o política? Elige el canal que prefieras y responderemos tan pronto como podamos.',
    ...
    contact_promise_2_strong: 'Respuesta lo antes posible',
    contact_promise_2_body: 'Los tiempos de respuesta pueden variar; procuramos ofrecer ayuda práctica y clara.',
    contact_promise_3_strong: 'Ayuda con pedidos todos los días',
    contact_promise_3_body: 'Podemos ayudar con seguimiento, devoluciones, cambios de dirección y preguntas de productos cuando el soporte esté disponible.',
    ...
    contact_faq_1_a: 'Tu enlace de seguimiento aparece en el correo de confirmación de envío cuando el seguimiento está disponible. Si tienes alguna pregunta sobre la entrega, escríbenos con tu número de pedido.',
    contact_faq_2_q: '¿Puedo cambiar o cancelar mi pedido?',
    contact_faq_2_a: 'Contáctanos lo antes posible con tu número de pedido. Confirmaremos si todavía es posible cambiar o cancelar antes del procesamiento.',
    contact_faq_3_q: '¿Cómo funcionan las devoluciones?',
    contact_faq_3_a: 'La elegibilidad y las instrucciones de devolución figuran en nuestra política de reembolso. Contáctanos antes de enviar cualquier artículo para recibir los pasos correctos.',
    contact_faq_4_q: '¿A dónde envían?',
    contact_faq_4_a: 'La entrega está disponible solo para direcciones en EE. UU. El costo y el plazo estimado se confirman al pagar y no están garantizados.',
    contact_faq_5_q: '¿Los productos en las fotos son exactamente lo que recibiré?',
    contact_faq_5_a: 'Las fotos y descripciones ayudan a comparar antes de comprar. Revisa todas las imágenes, opciones y detalles, y contáctanos si algo no está claro.',
    ...
    faq_orders_1_a: 'Los plazos varían según el producto y aparecen al pagar para direcciones en EE. UU. Son estimaciones, no fechas garantizadas.',
    faq_orders_2_q: '¿Envían a nivel internacional?',
    faq_orders_2_a: 'No. La entrega está disponible solo para direcciones en EE. UU.',
    faq_orders_3_q: '¿Cómo rastreo mi pedido?',
    faq_orders_3_a: 'Los detalles de seguimiento se envían por correo cuando están disponibles. Contáctanos con tu número de pedido si necesitas ayuda.',
    faq_orders_4_q: '¿Cuáles son sus tarifas de envío?',
    faq_orders_4_a: 'El costo de envío aparece al pagar según los productos y la dirección en EE. UU. antes del pago.',
    faq_returns_1_q: '¿Cuál es su política de devoluciones?',
    faq_returns_1_a: 'Nuestra política de reembolso ofrece un plazo de 30 días, sujeto a sus requisitos. Contáctanos antes de enviar cualquier artículo.',
    faq_returns_2_q: '¿Cómo inicio una devolución?',
    faq_returns_2_a: 'Contáctanos antes de devolver un artículo. Confirmaremos la elegibilidad, la dirección y las instrucciones; el envío de devolución se gestiona caso por caso.',
    faq_returns_3_q: '¿Cuándo recibiré mi reembolso?',
    faq_returns_3_a: 'Los reembolsos aprobados se emiten al método original, generalmente en 5–7 días hábiles tras recibir e inspeccionar la devolución.',
    faq_products_1_q: '¿Cómo revisan los productos?',
    faq_products_1_a: 'Antes del lanzamiento revisamos la ficha, la variante vendible, el mapeo del proveedor y la entrega a Estados Unidos. No autenticamos de forma independiente cada afirmación de marca ni probamos cada artículo en laboratorio; contáctanos si un detalle es esencial.',
    faq_products_2_q: '¿De dónde vienen sus productos?',
    faq_products_2_a: 'Los pedidos son procesados por proveedores externos mapeados y el origen puede variar. Revisa las imágenes, la opción elegida, la entrega estimada y las políticas antes de comprar.',
    faq_products_3_q: '¿Todos los productos vienen de Centroamérica?',
    faq_products_3_a: 'No. Puchica tiene raíces centroamericanas, pero el catálogo actual usa proveedores externos seleccionados por los detalles del producto, la calidad del mapeo y las rutas de entrega verificadas a Estados Unidos.',
    ...
    faq_cta_sub: 'Leemos cada mensaje y respondemos lo antes posible.',
    ...
    hero_split_trust: 'Shipping at checkout - Return policy available',
    hero_trust_returns: 'Ver política de devoluciones',
    ...
    trust_bar_returns_h: 'Política de devoluciones',
    trust_bar_returns_sub: 'Revisar elegibilidad',
  ...
  'pt-br': {
    ...
    hero_eyebrow: 'Seleção prática · Entrega nos EUA',
    ...
    ticker_returns: 'Política de devolução disponível',
    ...
    ship_title: 'Entrega somente nos EUA.',
    ship_sub: 'A entrega está disponível somente para endereços nos EUA. O custo e o prazo estimado variam por produto; confirme ambos no checkout. A data estimada não é garantida.',
    ...
    ship_hero_jump: 'Veja como a entrega é confirmada',
    ship_launch_hero_sub: 'A entrega está disponível somente para endereços nos EUA. O custo e o prazo estimado são confirmados no checkout para os itens do carrinho.',
    ship_launch_regions_eye: 'Mercado de lançamento',
    ship_launch_regions_title: 'A entrega está atualmente limitada aos Estados Unidos.',
    ship_launch_regions_sub: 'O checkout confirma a disponibilidade, o custo e o prazo estimado de cada produto antes do pagamento.',
    ship_launch_rates_eye: 'Antes de pagar',
    ship_launch_rates_title: 'Opções claras para o seu pedido.',
    ship_launch_rates_sub: 'O checkout mostra a disponibilidade para os itens e o endereço selecionados antes do pagamento.',
    ship_market_us_name: 'Estados Unidos',
    ship_market_us_detail: 'A disponibilidade, o custo e o prazo estimado são confirmados no checkout.',
    ship_check_destination_title: 'Verifique seu endereço',
    ship_check_destination_body: 'Informe seu endereço no checkout para ver as opções disponíveis.',
    ship_check_destination_eta: 'Disponibilidade exibida antes do pagamento',
    ship_check_items_title: 'Verifique os itens do carrinho',
    ship_check_items_body: 'As opções variam por produto, variante e endereço. O resultado do checkout se aplica ao seu pedido.',
    ship_check_items_eta: 'Sem promessa de entrega antes da confirmação',
    ship_check_tracking_title: 'Acompanhe seu pedido',
    ship_check_tracking_body: 'Quando há rastreamento disponível, os detalhes são enviados após o despacho.',
    ...
    ship_cta_sub: 'Explore o catálogo ativo para os EUA; as opções de envio aparecem no checkout.',
    ...
    trust_returns_title: 'Política de devolução',
    ...
    product_trust_returns: 'Política de devolução',
    product_trust_returns_sub: 'see the return policy',
    ...
    product_shipping_body: 'A entrega está disponível somente para endereços nos EUA. O custo e o prazo estimado aparecem no checkout. Os itens podem chegar separadamente de fornecedores terceirizados; as datas não são garantidas.',
    product_returns_h: 'Devoluções',
    product_returns_body: 'A elegibilidade, o prazo e as instruções de devolução estão em nossa política de reembolso. Fale conosco antes de enviar qualquer item para receber as orientações corretas.',
    product_help_h: 'Precisa de ajuda?',
    product_help_body: 'Fale conosco pela página de contato para verificar um produto, pedido ou política antes da compra.',
    ...
    cart_empty_perk_returns: 'Política de devolução disponível',
    ...
    cart_summary_checkout_unavailable_btn: 'Pagamento temporariamente indisponível',
    cart_summary_checkout_unavailable_help: 'Não foi possível preparar o pagamento. Atualize o carrinho e tente novamente.',
    cart_summary_checkout_retry: 'Atualizar carrinho',
    ...
    cart_summary_promo_apply: 'Aplicar',
    cart_summary_promo_invalid: 'Não foi possível aplicar esse código promocional.',
    cart_recovery_one: 'Que bom ter você de volta! Há {count} item no seu carrinho.',
    cart_recovery_many: 'Que bom ter você de volta! Há {count} itens no seu carrinho.',
    cart_recovery_cta: 'Concluir seu pedido',
    cart_recovery_dismiss: 'Fechar lembrete do carrinho',
    ...
    mobile_announce_foot: 'Envio no checkout · Ver política de devolução',
    mobile_announce_foot_sep: ' · ',
    ...
    cart_trust_returns: 'Ver política de devolução',
    cart_trust_shipping: 'Envio indicado no checkout',
    ...
    about_how_3_body: 'Antes de comprar, revise imagens, opções, preço, detalhes de entrega e links das políticas em um só lugar.',
    ...
    about_promise_quote: 'Antes de publicar um produto, revisamos o anúncio, a variante vendável, o mapeamento do fornecedor e a rota de entrega aos Estados Unidos. Mantemos um catálogo focado e removemos o que não atende a essas verificações.',
    ...
    about_story_3_body: 'O catálogo está focado em produtos ativos com detalhes mais claros sobre produtos, entrega e políticas.',
    ...
    about_values_4_body: 'Os pedidos são atendidos por fornecedores terceirizados vinculados. Os detalhes de envio e devolução são confirmados no checkout e nas nossas políticas.',
    ...
    contact_hero_sub: 'Dúvidas sobre pedido, produto ou política? Escolha o canal que preferir e responderemos assim que possível.',
    ...
    contact_promise_2_strong: 'Resposta assim que possível',
    contact_promise_2_body: 'O tempo de resposta pode variar; buscamos oferecer ajuda prática e clara.',
    contact_promise_3_strong: 'Ajuda com pedidos todos os dias',
    contact_promise_3_body: 'Podemos ajudar com rastreamento, devoluções, mudanças de endereço e dúvidas sobre produtos quando o suporte estiver disponível.',
    ...
    contact_faq_1_a: 'Seu link de rastreamento aparece no e-mail de confirmação de envio quando o rastreamento está disponível. Se tiver alguma dúvida sobre a entrega, escreva para nós com o número do pedido.',
    contact_faq_2_q: 'Posso alterar ou cancelar meu pedido?',
    contact_faq_2_a: 'Fale conosco o quanto antes com o número do pedido. Confirmaremos se ainda é possível alterar ou cancelar antes do processamento.',
    contact_faq_3_q: 'Como funcionam as devoluções?',
    contact_faq_3_a: 'A elegibilidade e as instruções de devolução estão em nossa política de reembolso. Fale conosco antes de enviar qualquer item para receber as orientações corretas.',
    contact_faq_4_q: 'Para onde vocês enviam?',
    contact_faq_4_a: 'A entrega está disponível somente para endereços nos EUA. O custo e o prazo estimado são confirmados no checkout e não são garantidos.',
    contact_faq_5_q: 'Os produtos nas fotos são exatamente o que vou receber?',
    contact_faq_5_a: 'As fotos e descrições ajudam na comparação antes da compra. Revise todas as imagens, opções e detalhes e fale conosco se algo não estiver claro.',
    ...
    faq_orders_1_a: 'Os prazos variam por produto e aparecem no checkout para endereços nos EUA. São estimativas, não datas garantidas.',
    faq_orders_2_q: 'Vocês enviam internacionalmente?',
    faq_orders_2_a: 'Não. A entrega está disponível somente para endereços nos EUA.',
    faq_orders_3_q: 'Como rastrear meu pedido?',
    faq_orders_3_a: 'Os detalhes de rastreamento são enviados por e-mail quando ficam disponíveis. Fale conosco com o número do pedido se precisar de ajuda.',
    faq_orders_4_q: 'Quais são as taxas de envio?',
    faq_orders_4_a: 'O custo de envio aparece no checkout conforme os produtos e o endereço nos EUA antes do pagamento.',
    faq_returns_1_q: 'Qual é a política de devoluções?',
    faq_returns_1_a: 'Nossa política de reembolso prevê um prazo de 30 dias, sujeito aos requisitos de elegibilidade. Fale conosco antes de enviar qualquer item.',
    faq_returns_2_q: 'Como iniciar uma devolução?',
    faq_returns_2_a: 'Fale conosco antes de devolver um item. Confirmaremos a elegibilidade, o endereço e as instruções; o frete de devolução é tratado caso a caso.',
    faq_returns_3_q: 'Quando receberei meu reembolso?',
    faq_returns_3_a: 'Os reembolsos aprovados são emitidos no método original, geralmente em 5–7 dias úteis após o recebimento e a inspeção.',
    faq_products_1_q: 'Como vocês revisam os produtos?',
    faq_products_1_a: 'Antes do lançamento, revisamos o anúncio, a variante vendável, o mapeamento do fornecedor e a entrega aos Estados Unidos. Não autenticamos de forma independente toda alegação de marca nem testamos cada item em laboratório; fale conosco se um detalhe for essencial.',
    faq_products_2_q: 'De onde vêm seus produtos?',
    faq_products_2_a: 'Os pedidos são processados por fornecedores terceirizados mapeados e a origem pode variar. Revise as imagens, a opção escolhida, a estimativa de entrega e as políticas antes de comprar.',
    faq_products_3_q: 'Todos os produtos vêm da América Central?',
    faq_products_3_a: 'Não. A Puchica tem raízes centro-americanas, mas o catálogo atual usa fornecedores terceirizados selecionados pelos detalhes do produto, qualidade do mapeamento e rotas de entrega verificadas aos Estados Unidos.',
    ...
    faq_cta_sub: 'Lemos todas as mensagens e respondemos assim que possível.',
    ...
    hero_split_trust: 'Shipping at checkout - Return policy available',
    hero_trust_returns: 'Ver política de devolução',
    ...
    trust_bar_returns_h: 'Política de devolução',
    trust_bar_returns_sub: 'Verificar elegibilidade',
