...
export const DICTIONARIES = {
  en: {
    ...
    product_story_title: 'A closer look.',
  ...
  fr: {
    ...
    product_tab_description: 'Description',
    product_story_title: 'Voyez-le de plus près.',
  ...
  es: {
    ...
    product_story_title: 'Un vistazo más de cerca.',
  ...
  'pt-br': {
    ...
    product_story_title: 'Veja mais de perto.',
