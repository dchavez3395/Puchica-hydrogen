...
export const DICTIONARIES = {
  ...
  fr: {
    ...
    about_how_3_body: "S’il passe, il est en boutique. Notre équipe vous aide à organiser tout retour admissible.",
    ...
    about_values_4_body: 'Chaque commande part d’un partenaire vérifié. Contactez le soutien pour organiser un retour admissible.',
    ...
    contact_faq_2_a: 'Dans les 2 heures suivant la commande, répondez à votre confirmation. Ensuite, la commande peut déjà être en traitement; les retours admissibles suivent la politique de remboursement.',
    contact_faq_3_q: 'Comment fonctionnent les retours ?',
    contact_faq_3_a: 'Écrivez à hello@puchica.ca avec votre numéro de commande pour organiser un retour admissible. Les remboursements approuvés sont émis après inspection.',
    ...
    faq_returns_1_a: 'Nous offrons des retours sous 30 jours pour la plupart des articles inutilisés dans leur emballage d’origine. Écrivez-nous si un article arrive endommagé ou incorrect.',
    faq_returns_2_q: 'Comment démarrer un retour ?',
    faq_returns_2_a: 'Écrivez à hello@puchica.ca avec votre numéro de commande avant tout envoi. Nous confirmerons l’admissibilité et les instructions de retour.',
  ...
  es: {
    ...
    about_how_3_body: 'Si pasa, está en la tienda. Nuestro equipo te ayuda a coordinar cualquier devolución elegible.',
    ...
    about_values_4_body: 'Cada pedido sale de un socio verificado. Contacta a soporte para coordinar una devolución elegible.',
    ...
    contact_faq_2_a: 'Dentro de las 2 horas, responde a la confirmación. Después el pedido puede estar en proceso; las devoluciones elegibles siguen la política de reembolso.',
    contact_faq_3_q: '¿Cómo funcionan las devoluciones?',
    contact_faq_3_a: 'Escribe a hello@puchica.ca con tu número de pedido para coordinar una devolución elegible. Los reembolsos aprobados se emiten después de la inspección.',
    ...
    faq_returns_2_a: 'Escribe a hello@puchica.ca con tu número de pedido antes de enviar algo. Confirmaremos la elegibilidad y las instrucciones.',
  ...
  'pt-br': {
    ...
    about_how_3_body: 'Se passa, está na loja. Nossa equipe ajuda a organizar qualquer devolução elegível.',
    ...
    about_values_4_body: 'Cada pedido sai de um parceiro verificado. Contate o suporte para organizar uma devolução elegível.',
    ...
    contact_faq_2_a: 'Em até 2 horas, responda à confirmação. Depois disso o pedido pode estar em processamento; devoluções elegíveis seguem a política de reembolso.',
    contact_faq_3_q: 'Como funcionam as devoluções?',
    contact_faq_3_a: 'Escreva para hello@puchica.ca com o número do pedido para organizar uma devolução elegível. Reembolsos aprovados são emitidos após inspeção.',
    ...
    faq_returns_2_a: 'Escreva para hello@puchica.ca com o número do pedido antes de enviar algo. Confirmaremos a elegibilidade e as instruções.',
