...
export const DICTIONARIES = {
  en: {
    ...
    // ── Store hero (ecommerce redesign) ──────────────────────
    store_hero_eyebrow: '6,000+ products · Free shipping across Canada',
    store_hero_heading: 'Everything worth buying, all in one place.',
    store_hero_body: 'Shop thousands of products across home, kitchen, electronics, phone cases, beauty, pet, sports, and more. Curated in Toronto, shipped worldwide.',

    // ── Department grid ───────────────────────────────────────
    dept_grid_eyebrow: 'Browse the store',
    dept_grid_heading: 'Shop by department',
    dept_grid_see_all: 'View all products',

    // ── Product rails (homepage) ───────────────────────────────
    home_rail_new_eyebrow: 'Just landed',
    home_rail_new_heading: 'New arrivals',
    home_rail_new_see_all: 'See all',
    home_rail_sale_eyebrow: 'On sale now',
    home_rail_sale_heading: 'Sale',
    home_rail_sale_see_all: 'Shop all sale',
    home_rail_sale_scroll_left: 'Scroll left',
    home_rail_sale_scroll_right: 'Scroll right',
    home_rail_foryou_eyebrow: 'Picked for you',
    home_rail_foryou_heading: 'For you',
    ...
    home_rail_gifts_heading: 'Gifts under $25',
    home_rail_gifts_see_all: 'See all',
  ...
  fr: {
    ...
    store_hero_eyebrow: '6 000+ produits · Livraison gratuite au Canada',
    store_hero_heading: 'Tout ce qui vaut la peine, au même endroit.',
    store_hero_body: "Des milliers de produits pour la maison, la cuisine, l'électronique, les coques de téléphone, la beauté, les animaux, le sport et plus. Sélectionnés à Toronto, livrés dans le monde entier.",

    dept_grid_eyebrow: 'Parcourir le magasin',
    dept_grid_heading: 'Magasiner par département',
    dept_grid_see_all: 'Voir tous les produits',

    home_rail_new_eyebrow: 'Arrivages',
    home_rail_new_heading: 'Nouveautés',
    home_rail_new_see_all: 'Voir tout',
    home_rail_sale_eyebrow: 'En soldes',
    home_rail_sale_heading: 'Soldes',
    home_rail_sale_see_all: 'Toutes les soldes',
    home_rail_sale_scroll_left: 'Défiler à gauche',
    home_rail_sale_scroll_right: 'Défiler à droite',
    home_rail_foryou_eyebrow: 'Sélection pour vous',
    home_rail_foryou_heading: 'Pour vous',
    home_rail_foryou_see_all: 'Voir tout',
    home_rail_foryou_scroll_left: 'Défiler à gauche',
    home_rail_foryou_scroll_right: 'Défiler à droite',
    home_rail_gifts_eyebrow: 'Idées cadeaux',
    home_rail_gifts_heading: 'Cadeaux sous 25 $',
    home_rail_gifts_see_all: 'Voir tout',
    home_rail_gifts_scroll_left: 'Défiler à gauche',
    home_rail_gifts_scroll_right: 'Défiler à droite',
  ...
  es: {
    ...
    store_hero_eyebrow: '6,000+ productos · Envío gratis en Canadá',
    store_hero_heading: 'Todo lo que vale la pena, en un solo lugar.',
    store_hero_body: 'Miles de productos para el hogar, cocina, electrónica, fundas de teléfono, belleza, mascotas, deportes y más. Seleccionados en Toronto, enviados a todo el mundo.',

    dept_grid_eyebrow: 'Explorar la tienda',
    dept_grid_heading: 'Comprar por departamento',
    dept_grid_see_all: 'Ver todos los productos',

    home_rail_new_eyebrow: 'Recién llegado',
    home_rail_new_heading: 'Llegadas nuevas',
    home_rail_new_see_all: 'Ver todo',
    home_rail_sale_eyebrow: 'En oferta',
    home_rail_sale_heading: 'Ofertas',
    home_rail_sale_see_all: 'Todas las ofertas',
    home_rail_sale_scroll_left: 'Desplazar a la izquierda',
    home_rail_sale_scroll_right: 'Desplazar a la derecha',
    home_rail_foryou_eyebrow: 'Seleccionado para ti',
    home_rail_foryou_heading: 'Para ti',
    ...
    home_rail_gifts_heading: 'Regalos bajo $25',
    home_rail_gifts_see_all: 'Ver todo',
  ...
  'pt-br': {
    ...
    account_orders_search_aria: 'Buscar pedidos',
    account_orders_filter_legend: 'Filtrar pedidos',
    account_orders_search_ph: 'No do pedido',
    account_orders_search_aria_named: 'Número do pedido',
    account_orders_conf_ph: 'No de confirmação',
    ...
    store_hero_eyebrow: '6.000+ produtos · Frete grátis no Canadá',
    store_hero_heading: 'Tudo que vale a pena, num só lugar.',
    store_hero_body: 'Milhares de produtos para casa, cozinha, eletrônicos, capas de telefone, beleza, pets, esportes e mais. Selecionados em Toronto, enviados para o mundo todo.',

    dept_grid_eyebrow: 'Explorar a loja',
    dept_grid_heading: 'Comprar por departamento',
    dept_grid_see_all: 'Ver todos os produtos',

    home_rail_new_eyebrow: 'Recém-chegado',
    home_rail_new_heading: 'Novidades',
    home_rail_new_see_all: 'Ver tudo',
    home_rail_sale_eyebrow: 'Em promoção',
    home_rail_sale_heading: 'Promoções',
    home_rail_sale_see_all: 'Todas as promoções',
    home_rail_sale_scroll_left: 'Rolar para a esquerda',
    home_rail_sale_scroll_right: 'Rolar para a direita',
    home_rail_foryou_eyebrow: 'Selecionado para você',
    home_rail_foryou_heading: 'Para você',
    ...
    home_rail_gifts_heading: 'Presentes até $25',
    home_rail_gifts_see_all: 'Ver tudo',
