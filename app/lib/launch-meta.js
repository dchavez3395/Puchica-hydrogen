...
const COPY = {
  ...
  //
  // "Thirteen fixtures" is the live ACTIVE count: the saucer, the dome, the
  ...
  // non-pendant), and the woven bamboo column re-sourced onto a 90-260 V
  // listing. Update this number when the ACTIVE count changes.
  en: {
    homeTitle: 'Puchica — Woven bamboo lighting',
    homeCa:
      'Woven bamboo pendant lighting, shipped across Canada. Thirteen fixtures listed today. Questions? hello@puchica.ca',
    homeUs:
  ...
  fr: {
    ...
    homeCa:
      'Suspensions en bambou tressé, livrées partout au Canada. Treize luminaires en ligne aujourd’hui. Questions : hello@puchica.ca',
    homeUs:
  ...
  es: {
    ...
    homeCa:
      'Lámparas colgantes de bambú tejido, con envío a todo Canadá. Hoy hay trece luminarias publicadas. ¿Preguntas? hello@puchica.ca',
    homeUs:
  ...
  'pt-br': {
    ...
    homeCa:
      'Pendentes de bambu tecido, com envio para todo o Canadá. Hoje há treze luminárias publicadas. Dúvidas? hello@puchica.ca',
    homeUs:
