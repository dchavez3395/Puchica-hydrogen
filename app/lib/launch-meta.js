...
const COPY = {
  ...
  //
  // "Twelve fixtures" is the live ACTIVE count: the saucer, the dome, the
  ...
  // bell, nest, slat pumpkin, globe), and later again the rattan cone wall
  // sconce, the first non-pendant. Update this number when the ACTIVE count
  // changes.
  en: {
    homeTitle: 'Puchica — Woven bamboo lighting',
    homeCa:
      'Woven bamboo pendant lighting, shipped across Canada. Twelve fixtures listed today. Questions? hello@puchica.ca',
    homeUs:
  ...
  fr: {
    ...
    homeCa:
      'Suspensions en bambou tressé, livrées partout au Canada. Douze luminaires en ligne aujourd’hui. Questions : hello@puchica.ca',
    homeUs:
  ...
  es: {
    ...
    homeCa:
      'Lámparas colgantes de bambú tejido, con envío a todo Canadá. Hoy hay doce luminarias publicadas. ¿Preguntas? hello@puchica.ca',
    homeUs:
  ...
  'pt-br': {
    ...
    homeCa:
      'Pendentes de bambu tecido, com envio para todo o Canadá. Hoje há doze luminárias publicadas. Dúvidas? hello@puchica.ca',
    homeUs:
