...
const COPY = {
  ...
  //
  // "Sixteen fixtures" is the live ACTIVE count: the saucer, the dome, the
  ...
  // slat drum and the hat-nest; MINUS the gourd, which went to COST_HOLD the
  // same night when its supplier repriced the variant. Update this number
  // when the ACTIVE count changes.
  en: {
    homeTitle: 'Puchica — Woven bamboo lighting',
    homeCa:
      'Woven bamboo pendant lighting, shipped across Canada. Sixteen fixtures listed today. Questions? hello@puchica.ca',
    homeUs:
  ...
  fr: {
    ...
    homeCa:
      'Suspensions en bambou tressé, livrées partout au Canada. Seize luminaires en ligne aujourd’hui. Questions : hello@puchica.ca',
    homeUs:
  ...
  es: {
    ...
    homeCa:
      'Lámparas colgantes de bambú tejido, con envío a todo Canadá. Hoy hay dieciséis luminarias publicadas. ¿Preguntas? hello@puchica.ca',
    homeUs:
  ...
  'pt-br': {
    ...
    homeCa:
      'Pendentes de bambu tecido, com envio para todo o Canadá. Hoje há dezasseis luminárias publicadas. Dúvidas? hello@puchica.ca',
    homeUs:
