...
const COPY = {
  ...
  //
  // "Twenty fixtures" is the live ACTIVE count: the saucer, the dome, the
  ...
  // bell, nest, slat pumpkin, globe), the rattan cone wall sconce (the first
  // non-pendant), the woven bamboo column re-sourced onto a 90-260 V
  // listing, the iron cage pendant (the first metal fixture), and three more
  // shapes off the column's listing: the wide-brim (released from hold), the
  // slat drum and the hat-nest. The gourd went to COST_HOLD that night on a
  // mis-keyed price read and came back on 2026-09-14 from a second, cheaper
  // source. Three arm sconces from listing 1005006439147774 (cage,
  // teardrop, lattice) followed on 2026-09-14. Update this number when the
  // ACTIVE count changes.
  en: {
    homeTitle: 'Puchica — Woven bamboo lighting',
    homeCa:
      'Woven bamboo pendant lighting, shipped across Canada. Twenty fixtures listed today. Questions? hello@puchica.ca',
    homeUs:
  ...
  fr: {
    ...
    homeCa:
      'Suspensions en bambou tressé, livrées partout au Canada. Vingt luminaires en ligne aujourd’hui. Questions : hello@puchica.ca',
    homeUs:
  ...
  es: {
    ...
    homeCa:
      'Lámparas colgantes de bambú tejido, con envío a todo Canadá. Hoy hay veinte luminarias publicadas. ¿Preguntas? hello@puchica.ca',
    homeUs:
  ...
  'pt-br': {
    ...
    homeCa:
      'Pendentes de bambu tecido, com envio para todo o Canadá. Hoje há vinte luminárias publicadas. Dúvidas? hello@puchica.ca',
    homeUs:
