const COPY = {
  en: {
    ...
    account: ['Profile — Puchica', 'Orders — Puchica', 'Addresses — Puchica', 'Order {name} — Puchica'],
  ...
  fr: {
    ...
    account: ['Profil — Puchica', 'Commandes — Puchica', 'Adresses — Puchica', 'Commande {name} — Puchica'],
  ...
  es: {
    ...
    account: ['Perfil — Puchica', 'Pedidos — Puchica', 'Direcciones — Puchica', 'Pedido {name} — Puchica'],
  ...
  'pt-br': {
    ...
    account: ['Perfil — Puchica', 'Pedidos — Puchica', 'Endereços — Puchica', 'Pedido {name} — Puchica'],
