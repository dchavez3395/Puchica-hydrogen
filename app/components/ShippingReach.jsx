 ...
 *
 * - `variant="cities"` (about page): 4-column region grid, each region
 *   as a card with the region heading and a list of cities.
 * - `variant="compact"` (contact page): 4-cell reach panel, one cell
 *   per region with city count.
 *
...
export function ShippingReach({variant = 'cities'}) {
  ...
  // variant === 'cities' — about page treatment.
  return (
