 ...
 * source of New Arrivals content (the Outdoor & Garden collection,
 ...
 * `new-arrivals` collection exists in Shopify — only `outdoor-garden`.
 *
...
export async function loader() {
  return redirect('/collections/outdoor-garden?sort=newest');
}
