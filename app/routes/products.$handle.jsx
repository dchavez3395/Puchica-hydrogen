...
import {IconTruck, IconReturn, IconShield} from '~/components/Icons';
  ...
  return (
    <div className="pk-product">
      ...
      <div className="pk-product__info">
        {product.vendor && <p className="pk-product__vendor">{product.vendor}</p>}
        <h1 className="pk-product__title">{title}</h1>
        <div className="pk-product__rating" aria-label="Rated 4.5 of 5">
          <span className="pk-stars">★★★★½</span>
          <span className="pk-card__reviews">(120 reviews)</span>
        </div>
